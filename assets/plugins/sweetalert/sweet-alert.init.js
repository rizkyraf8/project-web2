...
!function($) {
    ...
    SweetAlert.prototype.init = function() {
        ...
        $('#tab-kelas').click(function(){
            if (!$('#idSiswa').val()) {
                swal("Peringatan !","Silahkan isi siswa terlebih dahulu",'warning');
            };
        });
    ...
    $(document).on('click', '.del-dialog-child', function() {
        var parent = $(this).data("id");
        var func = $(this).data("function");
        var module = $(this).data("module");
        var controller = $(this).data("controller");
        ...
        if (route) {
            ...
            route = BASEURL+module+"/"+controller+"/delete_child/"+parent;
        }
